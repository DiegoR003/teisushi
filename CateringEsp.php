    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center caption mt-60">
                <h5>DISFRUTA DE LOS MEJORES PLATILLOS</h5>
                <h1>Nuestro Catering</h1>
                <a  href="#contacto" class="button-1 mt-15">Reserva tu evento<span></span></a>
...
<section class="section-padding">
  <div class="container">
    <div class="row align-items-center g-5">
      <div class="col-lg-6">
        <img src="img/catering-2.jpg" alt="Catering Tei Sushi" class="img-fluid rounded animate-on-scroll" data-anim="fadeInLeft">
      </div>
      <div class="col-lg-6">
        <h2 class="animate-on-scroll" data-anim="fadeInUp">Vive el arte de la cocina japonesa con el toque de la Baja</h2>
        <p class="mt-3 animate-on-scroll" data-anim="fadeInUp" data-delay="100">
          Tei Sushi Catering lleva la maestría de los sabores japoneses, los ingredientes más frescos y nuestra presentación
          distintiva directamente a tu villa, yate o evento privado. Ya sea una cena íntima para dos o una celebración frente al mar,
          nuestro equipo crea una experiencia diseñada para impresionar.
        </p>
        <ul class="list-unstyled mt-3 animate-on-scroll" data-anim="fadeInUp" data-delay="200">
          <li>• Catering exclusivo para villas, yates y eventos privados.</li>
          <li>• Sushi recién preparado con ingredientes de la más alta calidad.</li>
...
<div class="text-center mt-4">
  <a class="button-1 mt-15" data-bs-toggle="modal" data-bs-target="#menuPdfModal">
    <i class="bi bi-menu-button-wide me-1"></i> Ver Menú Completo
  </a>
</div>
  ...
  <div class="modal-dialog modal-xl modal-fullscreen-md-down">
    <div class="modal-content bg-dark menu-modal">
      <div class="modal-header border-0">
        <h5 class="modal-title text-white">Menú</h5>
      ...
      <div class="modal-body p-0">
        <div id="menuCarousel" class="carousel slide" data-bs-touch="true" data-bs-interval="false" data-bs-wrap="true">
          ...
          <!-- Indicadores (coinciden con 4 slides) -->
          <div class="carousel-indicators">
            <button type="button" data-bs-target="#menuCarousel" data-bs-slide-to="0" class="active" aria-label="Página 1"></button>
            <button type="button" data-bs-target="#menuCarousel" data-bs-slide-to="1" aria-label="Página 2"></button>
            <button type="button" data-bs-target="#menuCarousel" data-bs-slide-to="2" aria-label="Página 3"></button>
            <button type="button" data-bs-target="#menuCarousel" data-bs-slide-to="3" aria-label="Página 4"></button>
          </div>

          <!-- Slides -->
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="img/docs/Esp/1.jpg"  alt="Menú - Página 1" class="menu-img">
            </div>
            <div class="carousel-item">
              <img src="img/docs/Esp/2.jpg" alt="Menú - Página 2" class="menu-img">
            </div>
            <div class="carousel-item">
              <img src="img/docs/Esp/3.jpg" alt="Menú - Página 3" class="menu-img">
            </div>
            <div class="carousel-item">
              <img src="img/docs/Esp/4.jpg" alt="Menú - Página 4" class="menu-img">
            </div>
          </div>
...
<section id="contacto" class="testimonials contact-banner bg-img" data-background="img/banner2.jpg" data-overlay-dark="7">
  ...
  <div class="container py-5">
    <div class="row align-items-center g-4">
      ...
      <!-- IZQUIERDA: estrellas + texto (sin icono ni opentable) -->
      <div class="col-lg-6">
        ...
        <h5 class="text-white mb-0" style="max-width:520px;">
          Un lugar donde la elegancia y la safisticación se unen para ofrecer la mejor experiencia.
        </h5>
      </div>

      <!-- DERECHA: formulario dentro de contenedor (card) -->
      <div class="col-lg-6">
        <div class="contact-card">
          <h3 class="text-center text-dark mb-2">Reserva tu evento</h3>
          ...
          <form class="form1 clearfix" action="/php/contact.php" method="POST" >
            ...
            <input type="text" name="tel" class="form-control mb-3" placeholder="Teléfono" required>
            <input type="email" name="correo" class="form-control mb-3" placeholder="Correo" required>
            <textarea name="mensaje" class="form-control mb-3" rows="5" placeholder="Detalles del evento..." required></textarea>
            <button class="btn-form1-submit mt-15">Enviar</button>
          </form>
...
(function(){
  ...
  if (!items.length || typeof jQuery === 'undefined' || typeof jQuery.fn.waypoint === 'undefined') return;
